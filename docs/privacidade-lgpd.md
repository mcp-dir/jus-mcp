...
Jus MCP segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Infosimples** | BR | Consulta automatizada às fontes públicas oficiais (tribunais, cartórios, INPI, órgãos federais e estaduais). |
| **Direct Data** | BR | Consulta automatizada a bases de compliance, sanções e investigação cadastral. |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [jus@mcp.ai](mailto:jus@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
